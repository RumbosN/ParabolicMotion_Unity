...
public class BattleGameManager : Singleton<BattleGameManager>
{
    ...
    [SerializeField] private int _timeToDespawnSnowBall = 5;
    [SerializeField] private Transform _worldTransform;
    [SerializeField] private AudioClip _newPointSound;
    [SerializeField] private AudioClip _pontAgainstSound;

    private Dictionary<EPlayerId, int> _playerPoints;
    private AudioSource _soundEffects;
    
    public int TimeToDespawnSnowBall => _timeToDespawnSnowBall;
    ...
    public void IncreasePointsToPlayer(EPlayerId player)
    {
        ...
        _soundEffects.clip = (currentPlayer == player) ? _newPointSound : _pontAgainstSound;
        _soundEffects.Play();
